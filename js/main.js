...
iniciar.addEventListener('mouseenter', () => {
    acionar = setInterval( () => {
        t++;
        iniciar.style.backgroundImage = `linear-gradient(${-45 + t*50}deg, #59bd87, #15c3f7, #ac92d0, #ffcd56, #75be6b)`;
    }, 100 );
})

iniciar.addEventListener('mouseleave', () => {
    clearInterval(acionar);
    t = 0;
    iniciar.style.backgroundImage = 'linear-gradient(-45deg, #59bd87, #15c3f7, #ac92d0, #ffcd56, #75be6b)';
})